...
void ILI9341_Init_I(SPI_HandleTypeDef *spiLcdHandle, GPIO_TypeDef *csPORT, uint16_t csPIN, GPIO_TypeDef *resetPORT, uint16_t resetPIN);
void ILI9341_Init_II(GPIO_TypeDef *sckPORT, uint16_t sckPIN, GPIO_TypeDef *mosiPORT, uint16_t mosiPIN, GPIO_TypeDef *csPORT, uint16_t csPIN, GPIO_TypeDef *resetPORT, uint16_t resetPIN);
